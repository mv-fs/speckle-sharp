...
public class VectorToHostConverter : IRawConversion<SOG.Vector, AG.Vector3d>
{
  private readonly IConversionContextStack<Document, UnitsValue> _contextStack;

  public VectorToHostConverter(IConversionContextStack<Document, UnitsValue> contextStack)
  {
