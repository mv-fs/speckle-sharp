...
public class DBMeshToSpeckleConverter : IHostObjectToSpeckleConversion, IRawConversion<ADB.PolyFaceMesh, SOG.Mesh>
{
...
public class DBSubDMeshToSpeckleConverter : IHostObjectToSpeckleConversion, IRawConversion<ADB.SubDMesh, SOG.Mesh>
{
  private readonly IRawConversion<AG.Point3d, SOG.Point> _pointConverter;
  private readonly IRawConversion<Extents3d, SOG.Box> _boxConverter;
  private readonly IConversionContextStack<Document, UnitsValue> _contextStack;
